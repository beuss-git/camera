...
#define arducamSpiTransfer(val)                                                \
  spiReadWriteByte(val) //  SPI communication sends a byte
#define arducamSpiCsPinHigh(pin)                                               \
  spiCsHigh(pin) // Set the CS pin of SPI to high level
#define arducamSpiCsPinLow(pin)                                                \
  spiCsLow(pin) // Set the CS pin of SPI to low level
